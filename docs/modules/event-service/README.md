...
| Pull requests            | `pull_request_creation_started`, `pull_request_branch_pushed`, `pull_request_created`, `pull_request_updated`, `pull_request_closed`, `pull_request_reopened`, `pull_request_commented`, `pull_request_failed` | `github`             |
