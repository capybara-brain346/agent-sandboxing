...
const schema = z.object({
  ...
  SANDBOX_PROVISION_TIMEOUT_MS: z.coerce.number().int().positive().default(60000),
  SANDBOX_COMMAND_TIMEOUT_MS: z.coerce.number().int().positive().default(120000),
  ...
  COMMAND_OUTPUT_MAX_BYTES: z.coerce.number().int().positive().default(10485760),
});
